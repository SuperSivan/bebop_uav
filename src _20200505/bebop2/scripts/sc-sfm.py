...
ROOT_DIR = "/home/sivan7/Documents/sc-sfm/"
# Import Mask RCNN
...
def callback(data):
    ...
    if count == 1:
        ...
        #img_ori = np.array(Image.fromarray(frame).resize(856, 480))  
...
if __name__ == '__main__':
    ...
    weights = torch.load("/home/sivan7/Documents/sc-sfm/finetune_dispnet_model_best.pth.tar", map_location=device)
